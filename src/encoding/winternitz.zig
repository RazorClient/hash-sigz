...
pub fn WinternitzEncoding(comptime MessageHash: type) type {
    return struct {
        ...
        pub fn encode(self: *const WinternitzEncoding, allocator: std.mem.Allocator, message: []const u8, randomness: []const u8, epoch: u32) ![]u8 {
            ...
            const checksum_chunks = try bytesToChunks(allocator, &checksum_bytes, self.message_hash.chunk_size, self.num_checksum_chunks);
